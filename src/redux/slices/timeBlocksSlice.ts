  ...
  timeBlocks: [
    {
      ...
      color: 'primary.main',
      progressPercent: 0,
      timeStart: dayjs().startOf('hour').set('hour', 12),
      timeEnd: dayjs().startOf('hour').set('hour', 13),
      elapsed: 0,
    },
    {
      id: 1,
      name: 'And even small one!',
      duration: 10000,
      color: 'primary.main',
      progressPercent: 50,
      timeStart: dayjs().startOf('hour').set('hour', 12),
      timeEnd: dayjs().startOf('hour').set('hour', 12).set('second', 10),
      elapsed: 5000,
    },
  ],
};
